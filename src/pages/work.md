...
* **Graphics and rendering.** Improved vector graphics quality and GPU memory use through [MSAA anti-aliasing](https://github.com/zed-industries/zed/pull/22812) and [a reworked path renderer](https://github.com/zed-industries/zed/pull/29718), alongside gradients and vector path construction.
